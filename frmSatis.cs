...
namespace Stok_
{
    public partial class frmSatis : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection("Data Source=DESKTOP-2H3RKUH\\SQLEXPRESS;Initial Catalog=Stok_Takip;Integrated Security=True");
        ...
        private void hesapla()
        {
            ...
            {
                baglanti.Open();
                SqlCommand komut = new SqlCommand("select num(toplamfiyati) from sepet",baglanti);
